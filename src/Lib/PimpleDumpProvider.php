...
class PimpleDumpProvider implements ControllerProviderInterface, BootableProviderInterface, ServiceProviderInterface
{
    ...
    protected function parseItem(Container $container, $name)
    {
        try {
            ...
            if (isset($this->outOfRequestScopeTypes[$name])) {
                return ['name' => $name, 'type' => 'class', 'value' => $this->outOfRequestScopeTypes[$name]];
            }
            return null;
        }
